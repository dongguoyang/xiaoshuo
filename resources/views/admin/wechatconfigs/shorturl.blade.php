...
{{--    <hr style="border-color: #fff;margin: 0;">--}}
    <ul class="nav nav-pills">
        ...
        <li class="active"><a href="shorturl">生成短链接</a></li>
    ...
    <form method="post" accept-charset="UTF-8" id="ajaxform" class="form-horizontal ajaxform" enctype="multipart/form-data">
        ...
        <div class="form-group  " style="margin-top: 20px;">
            <label for="type" class="col-sm-2  control-label">原始链接</label>
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                    <input type="text" id="title" name="or_url" value="" class="form-control type" placeholder="输入 原始链接">
                </div>
            </div>
        </div>
        <div class="form-group  ">
            <label for="type" class="col-sm-2  control-label">短链接</label>
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                    <input type="text" id="desc" name="url" value="" class="form-control type">
                </div>
            </div>
        </div>
