        ...
        <div class="form-group  " style="margin-top: 20px;">
            ...
            <div class="col-sm-8">
                <div class="input-group">
                    ...
                    <input type="text" id="title" name="name" value="@if(isset($wechat['menu_list']['menu']['button'][0]['name'])){{$wechat['menu_list']['menu']['button'][0]['name']}}@endif" class="form-control type" placeholder="输入 名称">
                </div>
            </div>
        </div>
        <div class="form-group  ">
            <label for="type" class="col-sm-2  control-label">跳转url</label>
            <div class="col-sm-8">
                <div class="input-group">
                    <span class="input-group-addon"><i class="fa fa-pencil fa-fw"></i></span>
                    <input type="text" id="desc" name="url" value="@if(isset($wechat['menu_list']['menu']['button'][0]['url'])){{$wechat['menu_list']['menu']['button'][0]['url']}}@endif" class="form-control type" placeholder="输入 跳转url">
                </div>
            </div>
        </div>
