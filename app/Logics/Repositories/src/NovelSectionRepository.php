    ...
    public function SectionInfo($novel_id, $section_num) {
        ...
        $data = Cache::remember($key, 11440, function () use ($novel_id, $section_num) {
            ...
            if ($data) {
                ...
                $data['content'] = strstr($data['content'], 'www.zhengzhiwen.net')?'http://hangzhouxiaoshuo.oss-cn-hangzhou.aliyuncs.com'.str_replace('https://www.zhengzhiwen.net','',$data['content']):$data['content'];
                //$data['content'] = 'http://hangzhouxiaoshuo.oss-cn-hangzhou.aliyuncs.com'.str_replace('https://www.zhengzhiwen.net','',$data['content']);
