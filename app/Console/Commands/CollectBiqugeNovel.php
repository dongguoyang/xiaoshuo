...
class CollectBiqugeNovel extends Command
{
    use CollectTrait;
    /**
     ...
     *
     */
    protected $signature = 'novel:collect-biquge-wap {cookie} {--S|suitable_sex= : 抓取性别分类 male、female} {--H|host= : 指定采集的域名}';
    /**
    ...
    private function nonelList($page = 2){
        while ($page < 50) {
            //小说列表
